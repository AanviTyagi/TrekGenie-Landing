    ...
    <section className="relative py-24 bg-slate-50 overflow-hidden text-center z-10">
      ...
      */}
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6">
        ...
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-teal-50 text-teal-600 text-sm font-bold mb-8 shadow-sm">
           <Mountain size={16} />
        ...
        {/* Subtitle */}
        <p className="text-lg md:text-xl text-slate-500 max-w-2xl mx-auto mb-12 leading-relaxed font-medium font-sans">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            <a 
              ...
              className="w-auto h-14 px-8 rounded-2xl bg-gradient-to-r from-teal-400 to-cyan-400 hover:from-teal-500 hover:to-cyan-500 text-white font-bold text-lg flex items-center justify-center gap-2 transition-all transform hover:scale-105 shadow-lg shadow-teal-500/20"
            >
                Start Comparing Now
                <ArrowRight size={20} />
            </a>
        ...
        {/* Trust Indicators */}
        <div className="flex flex-wrap justify-center items-center gap-x-8 gap-y-3 text-sm text-slate-400 font-medium font-sans">
